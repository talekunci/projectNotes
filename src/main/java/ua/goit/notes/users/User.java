...
import ua.goit.notes.BaseEntity;
import ua.goit.notes.enums.Role;
...
public class User implements BaseEntity<UUID>, UserDetails {
    ...
    private Set<Note> notes;  //private User by;

    @ElementCollection(targetClass = Role.class, fetch = FetchType.EAGER)
    @CollectionTable(name = "users_notes", joinColumns = @JoinColumn(name = "user_id"))
